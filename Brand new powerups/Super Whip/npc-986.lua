...
local powerup = require("powerups/superWhip")
local superWhip = {}
local npcID = NPC_ID
...
function superWhip.onInitAPI()
	registerEvent(superWhip, "onNPCHarm")
	registerEvent(superWhip, "onNPCCollect")
end

function superWhip.onNPCHarm(token,v,harm,c)
