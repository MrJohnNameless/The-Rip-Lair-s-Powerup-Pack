...
npcManager.setNpcSettings(superHammerSettings)
...
function superHammer.onInitAPI()
	registerEvent(superHammer, "onNPCHarm")
end

function superHammer.onNPCHarm(token,v,harm,c)
