...
function leaf.onInitPowerupLib()
    leaf.spritesheets = {
        leaf:registerAsset(1, "iceLeaf-mario.png"),
        leaf:registerAsset(2, "iceLeaf-luigi.png"),
        leaf:registerAsset(3, "iceLeaf-peach.png"),
        leaf:registerAsset(4, "iceLeaf-toad.png"),
    }
end
