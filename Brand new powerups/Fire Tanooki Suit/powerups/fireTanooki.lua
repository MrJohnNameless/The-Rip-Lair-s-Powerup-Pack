...
function leaf.onInitPowerupLib()
    leaf.spritesheets = {
        leaf:registerAsset(1, "firetanooki-mario.png"),
        leaf:registerAsset(2, "firetanooki-luigi.png"),
        leaf:registerAsset(3, "firetanooki-peach.png"),
        leaf:registerAsset(4, "firetanooki-toad.png"),
        leaf:registerAsset(5, "firetanooki-link.png"),
    }
end
