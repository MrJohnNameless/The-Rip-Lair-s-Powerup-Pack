...
local powerup = require("powerups/invincibilityLeaf")

local powerup = {}
local npcID = NPC_ID

local cp = require("customPowerups")
local invincibilityLeaf = cp.addPowerup("Invincibility Leaf", "powerups/invincibilityLeaf", npcID)
...
function powerup.onInitAPI()
	...
	Cheats.register("needaninvincibilityleaf",{
		isCheat = true,
		activateSFX = 12,
