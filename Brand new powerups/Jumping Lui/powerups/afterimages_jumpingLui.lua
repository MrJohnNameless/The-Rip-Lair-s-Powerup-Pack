...
maskShader:compileFromFile(nil,  Misc.resolveFile("powerups/afterimages_jumpingLui_shader.frag"))
...
local playerNames = {"mario", "luigi", "peach", "toad", "link", "megaman", "wario"}
