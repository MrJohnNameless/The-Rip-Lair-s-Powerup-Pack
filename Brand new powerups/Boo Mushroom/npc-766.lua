...
local booMushroom = require("powerups/booMushroom")
local mushroom = {}
local npcID = NPC_ID

local cp = require("customPowerups")
local booMushroom = cp.addPowerup("Boo Mushroom", "powerups/booMushroom", npcID)
...
function mushroom.onInitAPI()
	...
	Cheats.register("needabooshroom",{
		isCheat = true,
		activateSFX = 12,
		aliases = booMushroom.aliases,
		onActivate = (function() 
...
function mushroom.onPostNPCCollect(v,p)
	...
	if not p.data.booMushroom then return end
