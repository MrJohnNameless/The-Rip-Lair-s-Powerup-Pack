...
local explosions = Particles.Emitter(0, 0, Misc.resolveFile("powerups/cp_fireshroom_explosion.ini"))
local apt = {}
...
function apt.onInitPowerupLib()
    apt.spritesheets = {
        apt:registerAsset(1, "fireshroom-mario.png"), --Mario
        apt:registerAsset(2, "fireshroom-luigi.png"), --Luigi
        apt:registerAsset(3, "fireshroom-peach.png"), --Peach
        apt:registerAsset(4, "fireshroom-toad.png"), --Toad
        apt:registerAsset(5, "fireshroom-link.png"), --Link
    }

    apt.gpImages = {
        apt:registerAsset(CHARACTER_MARIO, "fireshroom-groundPound-1.png"),
        apt:registerAsset(CHARACTER_LUIGI, "fireshroom-groundPound-2.png"),
    }
end
